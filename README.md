...
This is multithreaded Python version of [blacklist-check-unix-linux-utility](https://github.com/adionditsak/blacklist-check-unix-linux-utility) that should work cross OS
